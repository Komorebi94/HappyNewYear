...
describe('getDayWorkoutRecord', () => {
    it('ignores redeem when checking daily workout', () => {
        const list = [
            { date: '2026-05-22', status: RECORD_STATUS.REDEEM, moneyChange: -10, remark: '兑换', afterMoney: 0 },
            { date: '2026-05-22', status: RECORD_STATUS.FINISH, moneyChange: 5, remark: '完成', afterMoney: 5 }
        ]
