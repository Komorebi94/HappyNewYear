...
export const LEG_EXERCISES = [
    { id: 'chair_squat', label: '靠椅深蹲', icon: '🪑', type: 'reps', baseReps: 8, baseSets: 3, repCap: 18 },
    { id: 'squat', label: '自重深蹲', icon: '🦵', type: 'reps', baseReps: 6, baseSets: 3, repCap: 20 },
    { id: 'lunge', label: '弓步蹲', icon: '🏃', type: 'reps', baseReps: 6, baseSets: 3, repCap: 14, suffix: '（每侧）' },
    { id: 'squat_hold', label: '靠墙静蹲', icon: '🧘', type: 'hold', baseSec: 20, baseSets: 3, secCap: 60 }
]

export const CORE_EXERCISES = [
    { id: 'plank', label: '平板支撑', icon: '🧱', always: true, type: 'hold', baseSec: 20, baseSets: 2, secCap: 90 },
    { id: 'wall_angle', label: '靠墙夹背', icon: '🤝', type: 'hold', baseSec: 15, baseSets: 3, secCap: 45 },
    { id: 'glute_bridge', label: '臀桥', icon: '🌉', type: 'reps', baseReps: 10, baseSets: 3, repCap: 20 },
    { id: 'dead_bug', label: '死虫式', icon: '🐛', type: 'reps', baseReps: 8, baseSets: 3, repCap: 16, suffix: '（每侧）' },
    { id: 'side_plank', label: '侧平板支撑', icon: '↔️', type: 'hold', baseSec: 15, baseSets: 2, secCap: 45, suffix: '（每侧）' }
]

export const FINISHER_EXERCISES = [
    { id: 'jumping_jack', label: '开合跳', icon: '⭐', type: 'reps', baseReps: 12, baseSets: 2, repCap: 30, minSession: 12 },
