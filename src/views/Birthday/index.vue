<template>
    <div
        ...
        :class="[
            deviceType,
            { 'is-reduced-motion': reducedMotion, 'is-celebrating': celebrated }
        ]"
...
const subtitle = computed(() =>
    buildBirthdaySubtitle(shareName.value, age.value)
)
...
@keyframes balloon-rise {
    ...
    10% { opacity: 1; }
    55% { transform: translateY(-58vh) translateX(14px); }
    100% {
...
.candle {
    ...
    &.lit {
        ...
        &::after {
            transform: scale(1);
            background: radial-gradient(circle, #fffef0 0%, #ffd166 35%, #ff8c42 70%, transparent 100%);
...
@keyframes candle-pop {
    from { transform: scaleY(0.6); opacity: 0.3; }
    to { transform: scaleY(1.02); opacity: 1; }
}
...
.celebrate-btn {
    ...
    &:active {
        ...
        box-shadow: 0 2px 0 rgba(0, 0, 0, 0.15), 0 4px 16px rgba(255, 107, 203, 0.4);
    }
